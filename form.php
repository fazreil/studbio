...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bio_main (course_name,course_start,course_end,ic_no,rank,name,unit_from,squadron,service_start,service_type,sevice_end,birth_date,marital_status,first_parent_name,first_relate_type,first_address,first_phone,first_near_cop,sec_parent_name,sec_relate,sec_address,sec_phone,sec_near_cop,first_age,sec_age,third_age,forth_age,fifth_age,sixth_age,first_sex,sec_sex,third_sex,fourth_sex,fifth_sex,sixth_sex,school,old_srp_year,old_spm_year,old_stpm_year,first_srp_grade,sec_srp_grade,third_srp_grade,fourth_srp_grade,first_spm_grade,sec_spm_grade,third_spm_grade,forth_spm_grade,first_stpm_grade,sec_stpm_grade,third_stpm_grade,forth_stpm_grade,new_srp_year,new_spm_year,new_stpm_year,bm_srp,bm_spm,bm_stpm,bi_srp,bi_spm,bi_stpm,math_srp,math_spm,math_stpm,sci_srp,sci_spm,sci_stpm,hist_srp,hist_spm,hist_stpm,geo_srp,geo_spm,geo_stpm,pi_srp,pi_spm,pi_spm,draw_srp,draw_spm,draw_stpm,lite_srp,lite_spm,lite_stpm,eco_srp,eco_spm,eco_stpm,wri_bm,spe_bm,wri_eng,spe_eng,first_ins_no,first_ins_name,first_unit_amount,sec_ins_no,sec_ins_name,sec_unit_amout,third_ins_no,third_ins_name,third_ins_amount,first_job_post,first_job_dept,sec_job_post,sec_job_dept,first_course_name,first_course_place,first_course_end,sec_course_name,sec_course_place,sec_course_end,third_course_name,third_course_place,third_course_end,fourth_course_name,fourth_course_place,fourth_course_end,fifth_course_name,fifth_course_place,fifth_course_end,first_unit_from,first_unit_till,first_unit_rank,first_unit_post,first_unit_unit,sec_unit_from,sec_unit_till,sec_unit_rank,sec_unit_post,sec_unit_unit,third_unit_from,third_unit_till,third_unit_rank,third_unit_post,third_unit_unit,fourth_unit_from,fourth_unit_till,fourth_unit_rank,fourth_unit_post,fourth_unit_unit,fifth_unit_from,fifth_unit_till,fifth_unit_rank,fifth_unit_post,fifth_unit_unit,first_place_choose,sec_place_choose,sport,hobby,confirm_date) VALUES (
